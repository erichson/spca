...
spca_out <- rspca(X, k=3, alpha=0, beta=0, center = TRUE, scale = FALSE, verbose=0) #Sparse PCA
...
spca_out <- rspca(X, k=3, alpha=0, beta=0, center = TRUE, scale = TRUE, verbose=0) #Sparse PCA
...
#*************************************************************************************
spca_out <- rspca(X, k=3, alpha=1e-3, beta=0, center = TRUE, scale = FALSE, verbose=0) #Sparse PCA
...
spca_out <- rspca(X, k=3, alpha=1e-3, beta=1e-3, center = TRUE, scale = FALSE, verbose=0) #Sparse PCA
