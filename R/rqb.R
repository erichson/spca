...
#' @export
compress_qb <- function(A, k=NULL, p=10, q=2, sdist="normal", rand = TRUE) UseMethod("rqb")

#' @export
compress_qb.default <- function(A, k=NULL, p=10, q=2, sdist="normal", rand = TRUE) {
    ...
    #B := Q.T * A
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    rqbObj$B <- crossprod_helper(rqbObj$Q , A )
...
tcrossprod_helper <- function( A , B ) {
  if(is.complex(B)) {
